...
namespace SpaceGame.Entities
{
	public partial class EnemySpawner
	{
        ...
        double mLastSpawnTimeS;
        private bool IsTimeToSpawnS
        {
            get
            {
                return FlatRedBall.Screens.ScreenManager.CurrentScreen.PauseAdjustedSecondsSince(mLastSpawnTimeS) > 1.0 / SpinnerPerSecond;
            }
        }

        double mLastSpawnTimeK;
        private bool IsTimeToSpawnK
        {
            get
            {
                return FlatRedBall.Screens.ScreenManager.CurrentScreen.PauseAdjustedSecondsSince(mLastSpawnTimeK) > 1.0 / KamikazePerSecond;
            }
        }

        double mLastSpawnTimeJ;
        private bool IsTimeToSpawnJ
        {
            get
            {
                return FlatRedBall.Screens.ScreenManager.CurrentScreen.PauseAdjustedSecondsSince(mLastSpawnTimeJ) > 1.0 / JumperPerSecond;
            }
        }
        ...
        private void SpawnJumper()
        {
            ...
            EnemyJumper jumper = EnemyJumperFactory.CreateNew();
            jumper.CurrentState = EnemyJumper.VariableState.DarkGrey;
            jumper.Position = position;
            jumper.Velocity = velocity;

            mLastSpawnTimeJ = FlatRedBall.Screens.ScreenManager.CurrentScreen.PauseAdjustedCurrentTime;
        }

        private Vector3 GetRandomSpinnerPosition()
        {
            ...
            int randomSide = FlatRedBallServices.Random.Next(3);
        ...
        private Vector3 GetRandomSpinnerVelocity(Vector3 position)
        {
        ...
        private void GetRandomKamikazePosition()
        {
        }

        private void GetRandomKamikazeVelocity()
        {

        }

        private void GetRandomJumperPosition()
        {

        }

        private void GetRandomJumperVelocity()
        {
